...
{
    // 最初にスポーンするアイテムの数
    private readonly int ITEM_FIRST_SPAWNED_COUNT = 30;
    ...
    public void OnSceneLoadDone(NetworkRunner runner)
    {
        ...
        GameObject prefabObj = Resources.Load<GameObject>("Item1NetWorkObject");
        ...
        {
            itemCount++;
            runner.Spawn(networkPlayerObject, itemPositionList[i], Quaternion.identity, null);
